"""
train_pneumonia.py — ONCOSIGHT AI (FAST TRANSFER LEARNING)
DenseNet121 binary classifier for Pneumonia X-Ray detection.
"""
...
SAVE_PATH   = os.path.join(os.path.dirname(__file__), '..', 'saved_models', 'pneumonia_model.pth')
IMG_SIZE    = 160
BATCH_SIZE  = 32
EPOCHS      = 9
LR          = 1e-4
...
print(f"[train_pneumonia] Device: {DEVICE}")
...
# Increase penalty for missing pneumonia abnormalities
if len(weights) > 1:
    weights[1] *= 1.5
...
class DenseNet121Classifier(nn.Module):
    def __init__(self, num_classes=2):
        ...
        # Freeze early layers for fast transfer learning
